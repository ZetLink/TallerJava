...
public class Arbol {
    ...
    public void insertarNodo(NodoArbol p, Palabra dato){
        if (dato.getCod() != p.getDato().getCod()){
            if (dato.getCod() < p.getDato().getCod()){
                if (p.getPI() == null){
    ...
    public Palabra buscar(NodoArbol p, int dni, Palabra q) {
        if (p == null){
            return null;
        } else if (p.getDato().getCod() == dni){
            q = p.getDato();
            return q;
        } else if (p.getDato().getCod() > dni){
