...
public class ArbolBinarioBusqueda extends ArbolBinario {
    ...
    public void insertar(NodoLista dato) {
        BibliotecaEscolar aux = (BibliotecaEscolar) dato.getDato();
        if (esVacio()) {
...
//     El nodo se inserta a la izq si es menor y a la der si es mayor
    private void insertarNodo(NodoArbol p, NodoLista dato) {
        ...
        BibliotecaEscolar libInicio = (BibliotecaEscolar) listaInicio.getDato();
        BibliotecaEscolar libObjeto = (BibliotecaEscolar) listaObjeto.getDato();
...
//        dato = (Comparador) buscado;
        BibliotecaEscolar aux = (BibliotecaEscolar) buscado.getDato();
        if (raiz == null) {
            return null;
        } else {
    ...
    private NodoArbol localizar(NodoArbol raizSub, int buscado) {
        BibliotecaEscolar aux  = (BibliotecaEscolar) raizSub.getDato();
        if (raizSub == null) {
            return null;
